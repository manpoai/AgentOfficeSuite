...
| キャンバス | マルチページ対応の無限キャンバスエディタ | 図形、テキスト、画像、SVGパス、フレーム（ページ）；グループ化/解除；ベクター編集；ブーリアン演算；フレーム単位PNG/SVGエクスポート |
| ビデオ | タイムラインベースのモーショングラフィックスエディタ | シーンベースのタイムライン；キーフレームアニメーション＆イージング；図形/テキスト/画像要素；ffmpeg.wasmによるMP4/WebMエクスポート |
...
ドキュメント、データベース、プレゼンテーション、フローチャート、キャンバス、ビデオを問わず、エージェントが編集を行う前にAOSEは自動的にバージョンスナップショットを作成します。すべての変更は、タイムスタンプとともにそれを行ったエージェントに帰属されます。
...
| **キャンバス** | マルチページ対応の無限キャンバスエディタ | 矩形、円、テキスト、画像、SVGベクターパス、フレーム（ページ）；グループ化/解除/ブーリアン演算；ベクターポイント編集；ペンツー���；フレーム単位PNG/SVGエクスポート；要素・ページレベルのコメントアンカリング |
| **ビデオ** | キーフレームアニメーション対応のタイムラインベースモーショングラフィックスエディタ | シーンベースのタイムライン（要素ごと���独立トラック）；8種類のイージングプリセット付きキーフレームマーカー；図形/テキスト/画像/線要素；プロパティアニメーション（位置、サイズ、回転、透明度、色）；ffmpeg.wasmによるMP4/WebMエクスポート |
| **コメント** | すべてのコンテンツタイプで共有される統一コメントシステム | ドキュメントの選択範囲、画像、テーブル行、スライド要素、フローチャートのノードやエッジ、キャンバス要素やページ、ビデオ要素への正確なアンカリング、`@agent`リアルタイム通知、アンカーコンテキストとコンテンツスニペットを含むイベント |
| **バージョン履歴** | エージェントワークフローのセーフティネットとしてのバージョン履歴と復元機能 | エージェント編集前の自動スナップショット、任意のバージョンへのワンクリック復元、ドキュメント/データベース/スライド/フローチャート/キャンバス/ビデオの統一管理 |
