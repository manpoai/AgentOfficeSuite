...
cp -R gateway/server.js gateway/routes gateway/middleware gateway/lib gateway/locales gateway/init-db.sql gateway/package.json gateway/package-lock.json gateway/seed-data.json gateway/seed-assets "$DIST_DIR/gateway/"
